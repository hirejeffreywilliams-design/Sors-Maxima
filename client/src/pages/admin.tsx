...
export default function AdminDashboard() {
  ...
  const quickLinks = [
    ...
    { href: "/admin/learning",           label: "Learning System",        desc: "Pick feedback, model snapshots, audit trail", icon: Brain },
  ...
  const allToolSections = [
    ...
    },
    {
      ...
      tools: [
        ...
        { href: "/admin/learning",            label: "Learning System",      icon: Brain },
