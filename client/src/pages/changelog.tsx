...
const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      { text: "AI-powered quantum diagnostics for admin", icon: Brain, tag: "new" },
  ...
  },
  {
    ...
    date: "January 2026",
    type: "major",
    title: "Quantum Fusion Engine & Pro Tools",
    highlights: [
      { text: "Quantum Fusion Engine integrating 46 factors across 7 categories", icon: Brain, tag: "new" },
  ...
  },
  {
    ...
    highlights: [
      ...
      { text: "Monte Carlo simulation engine for probability analysis", icon: Brain, tag: "new" },
