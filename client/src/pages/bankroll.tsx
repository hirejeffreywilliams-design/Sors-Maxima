...
import { Wallet, BarChart3, FileText, Atom } from "lucide-react";
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Track your sportsbook balances, ROI, and generate tax reports</p>
          </div>
        </header>
