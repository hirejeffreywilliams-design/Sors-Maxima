...
function generateStrategyLegs(strategy: string, legCount: number, sports: string): StrategyLeg[] {
  const allLegs: StrategyLeg[] = [
    ...
    { sport: "NBA", game: "Lakers @ Celtics", pick: "Celtics -4.5", odds: -110, confidence: 75, correlation: "home", reasoning: "Celtics 12-2 at home, Lakers on B2B" },
    { sport: "NBA", game: "Warriors @ Bucks", pick: "Over 228.5", odds: -108, confidence: 70, correlation: "pace", reasoning: "Both teams top-10 pace, expect shootout" },
