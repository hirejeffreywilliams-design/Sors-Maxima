...
import { MapPin, Cloud, Wind, Thermometer, Mountain, TrendingUp, TrendingDown, Home, Plane, AlertTriangle } from "lucide-react";
  ...
  return [
    ...
    },
    {
      ...
      factors: [
        ...
        { factor: "Travel", impact: "positive", description: "DAL flying in same day" },
        { factor: "Back-to-Back", impact: "positive", description: "Mavericks on B2B, Nuggets rested" },
      ],
      recommendation: "Major altitude + rest advantage. Nuggets dominate at home. Mavericks struggle late.",
    },
    {
      id: "3",
