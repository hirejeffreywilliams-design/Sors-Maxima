...
function generateComprehensiveMatchups(): MatchupAnalysis[] {
  return [
    ...
    },
    {
      ...
      factors: [
        { type: "Matchup", impact: "positive", description: "AD questionable - backup C struggles", weight: 22 },
        { type: "Pace", impact: "neutral", description: "LAL plays at average pace", weight: 0 },
        { type: "Minutes", impact: "positive", description: "Averages 35.2 MPG (top 10)", weight: 12 },
        { type: "Historical", impact: "positive", description: "7-1 over this line vs LAL", weight: 18 },
    ...
    {
      id: "nba-3",
      player: { id: "p6", name: "Stephen Curry", team: "GSW", position: "PG", number: 30 },
      defender: null,
      opponent: "Suns",
      gameTime: "Tonight 10:00 PM",
      sport: "NBA",
      ...
      factors: [
        ...
        { type: "Shooting Luck", impact: "positive", description: "Due for regression to mean", weight: 8 },
