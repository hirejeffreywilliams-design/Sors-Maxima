...
export function securityHeadersMiddleware(_req: Request, res: Response, next: NextFunction) {
  ...
  res.setHeader(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https:; connect-src 'self' https://site.api.espn.com https://api.stripe.com https://api.the-odds-api.com https://api.balldontlie.io https://api.openweathermap.org https://api.open-meteo.com; font-src 'self' data: https://fonts.gstatic.com; frame-ancestors 'none';"
  );
