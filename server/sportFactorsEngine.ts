...
const SIGNAL_MODIFIER_MAP: Record<string, Record<string, number>> = {
  ...
  NHL: {
    momentum_score: 1.2, biomech_fatigue: 1.3, equipment_advantage: 1.2, rest_advantage: 1.25,
  ...
  "Horse Racing": {
    ...
    rest_advantage: 1.15, historical_h2h: 1.15, coaching_tendency: 1.2, equipment_advantage: 1.2,
  ...
  Motorsport: {
    equipment_advantage: 1.4, weather_impact: 1.3, field_conditions: 1.25, player_efficiency: 1.2,
    ...
    altitude_adjustment: 1.1, clutch_index: 1.15, training_tech: 1.15, video_analysis: 1.15,
  },
  "Boxing/MMA": {
    ...
    video_analysis: 1.15, wearable_data: 1.1, recovery_status: 1.15, nutrition_hydration: 1.15,
  },
  Esports: {
    ...
    rest_advantage: 1.15, equipment_advantage: 1.2, training_tech: 1.15, video_analysis: 1.2,
