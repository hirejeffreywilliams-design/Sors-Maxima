...
export const overdriveCache = pgTable("overdrive_cache", {
  gameId: varchar("game_id", { length: 64 }).primaryKey(),
  sport: varchar("sport", { length: 10 }).notNull(),
  homeTeam: varchar("home_team", { length: 100 }).notNull(),
  awayTeam: varchar("away_team", { length: 100 }).notNull(),
  gameStartTimeSec: integer("game_start_time_sec").notNull(),
  ...
  ciHomeWinLow: real("ci_home_win_low"),
  ciHomeWinHigh: real("ci_home_win_high"),
  ciTotalLow: real("ci_total_low"),
  ciTotalHigh: real("ci_total_high"),
  variance: real("variance"),
  tier: varchar("tier", { length: 20 }).notNull(),
  updatedAt: timestamp("updated_at").defaultNow().notNull(),
  accTotalSims: integer("acc_total_sims").default(0),
  accHomeWins: integer("acc_home_wins").default(0),
  accHomeScoreN: integer("acc_home_score_n").default(0),
  accHomeScoreMean: real("acc_home_score_mean").default(0),
  accHomeScoreM2: real("acc_home_score_m2").default(0),
  accAwayScoreN: integer("acc_away_score_n").default(0),
  accAwayScoreMean: real("acc_away_score_mean").default(0),
  accAwayScoreM2: real("acc_away_score_m2").default(0),
  accTotalScoreN: integer("acc_total_score_n").default(0),
  accTotalScoreMean: real("acc_total_score_mean").default(0),
  accTotalScoreM2: real("acc_total_score_m2").default(0),
  accSpreadCovers: integer("acc_spread_covers").default(0),
  accOvers: integer("acc_overs").default(0),
  p10HomeScore: real("p10_home_score"),
  p50HomeScore: real("p50_home_score"),
  p90HomeScore: real("p90_home_score"),
  p10AwayScore: real("p10_away_score"),
  p50AwayScore: real("p50_away_score"),
  p90AwayScore: real("p90_away_score"),
});
