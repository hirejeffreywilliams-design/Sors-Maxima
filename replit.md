...
- **Trial System**: 7-day trial of Pro/Sharp tier on registration. After trial expires, users are downgraded to Free tier (not auto-upgraded). Users must subscribe via Stripe to access premium features.
